app.controller("homeController",['$scope','$location','$window','$http',function(  $scope , $location, $window, $http){
	...
	$scope.Reset = function(){
		...
		$scope.UsernameError = $scope.EmailError = $scope.PasswordError = $scope.ConfirmPasswordError = $scope.LocationError = $scope.PhoneError = false;
		$scope.UsernameTouched = $scope.EmailTouched = $scope.PasswordTouched = $scope.ConfirmPasswordTouched = $scope.LocationTouched = $scope.PhoneTouched = false;
	}
