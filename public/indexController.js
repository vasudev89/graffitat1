app.controller("indexController",['$scope','$location','$window','$http',function(  $scope , $location, $window, $http){
	...
	$scope.Reset = function(){
		$scope.Username = $scope.Email = $scope.Password = $scope.ConfirmPassword = $scope.Location = $scope.Qualifications = $scope.Phone = '';
		$scope.UsernameError = $scope.EmailError = $scope.PasswordError = $scope.ConfirmPasswordError = $scope.LocationError = $scope.QualificationsError = $scope.PhoneError = false;
		$scope.UsernameTouched = $scope.EmailTouched = $scope.PasswordTouched = $scope.ConfirmPasswordTouched = $scope.LocationTouched = $scope.QualificationsTouched = $scope.PhoneTouched = false;
	}
